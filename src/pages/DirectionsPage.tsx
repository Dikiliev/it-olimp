                    ...
                    <Box sx={{
                        ...
                        <Box sx={{ flex: '1 1 50%' }}>
                            ...
                            <Typography variant="body1" sx={{ mb: 2 }}>
                                Данные олимпиады проводятся с 2020 года на базе Чеченского государственного университета имени А.А. Кадырова в Агротехническом институте.
                            </Typography>
                            <Typography variant="body1" sx={{ mb: 2 }}>
                                Каждый год мы собираем огромное количество студентов и школьников для проведения этого масштабного мероприятия. Данные олимпиады проводятся с 2020 года на базе Чеченского государственного университета имени А.А. Кадырова в Агротехническом институте.
                            </Typography>
                            <Typography variant="body1" sx={{ mb: 2 }}>
